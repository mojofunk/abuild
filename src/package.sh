...
{
	PKG_DEFAULT_SRC_ROOT_DIR="$ABUILD_ROOT_PATH_SOURCE"
...
function set_pkg_build_dir_env
{
	...
	PKG_DEFAULT_BUILD_ROOT_DIR="$ABUILD_ROOT_PATH_BUILD/$PKG_DEFAULT_BUILD_ROOT_DIR_NAME"
...
function set_pkg_install_dir_env
{
	...
	: ${PKG_INSTALL_ROOT_DIR:="$ABUILD_ROOT_PATH_INSTALL"}
